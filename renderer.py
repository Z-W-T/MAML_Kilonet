...
class VolumeRender:
    ...
    def render(self, off_screen=True, file_name=None, view_blocks=4):
        # TODO res可变的
        ...
        for i in range(11):
            opacityTransferFunction.AddPoint(i/10, i/30)
        # opacityTransferFunction.AddPoint(0, 0.7)
        # opacityTransferFunction.AddPoint(0.1, 0.5)
        ...
        for i in range(11):
            colorTransferFunction.AddRGBPoint(i/10, perceptual_color_map[i][0],
                                              perceptual_color_map[i][1], perceptual_color_map[i][2])

        # colorTransferFunction.AddRGBPoint(1.3, 0.0, 0.0, 1.0)
        # colorTransferFunction.AddRGBPoint(2.8, 1.0, 1.0, 1.0)
        # colorTransferFunction.AddRGBPoint(4.3, 1.0, 0.0, 0.0)
